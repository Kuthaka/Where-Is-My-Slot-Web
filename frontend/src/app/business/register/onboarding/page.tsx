      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full flex items-center justify-center pt-[96px] pb-12 px-4 lg:px-8">
        <div className="max-w-4xl w-full bg-white dark:bg-[#242424] rounded-3xl shadow-xl border border-gray-200 dark:border-gray-800 overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/3 bg-gray-900 dark:bg-[#111] p-8 text-white flex flex-col justify-between">
            <div>
              <div className="mb-12">
                ...
                <p className="text-gray-400 text-sm">Create your business profile in 4 simple steps.</p>
              </div>
                  ...
                  return (
                    <div key={step.id} className={`flex items-center gap-4 ${isActive ? "opacity-100" : isPassed ? "opacity-70" : "opacity-40"}`}>
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${
                        isActive ? "bg-yellow-400 text-black shadow-lg shadow-yellow-400/20" : isPassed ? "bg-yellow-400 text-black" : "bg-white/10 text-white"
                      }`}>
                        {isPassed ? <Check size={20} strokeWidth={3} /> : <Icon size={20} />}
                      </div>
                      <div>
                        <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Step {step.id}</p>
            ...
            <div className="hidden md:block mt-12 bg-white/10 p-6 rounded-2xl">
              ...
              <p className="text-sm text-gray-400">Contact our merchant support team at support@localplatform.com</p>
            </div>
          </div>
          ...
          <div className="flex-1 p-8 sm:p-12">
              ...
              <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <input required name="name" value={formData.name} onChange={handleChange} className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all text-gray-900 dark:text-white" placeholder="e.g. The Grand Cafe" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Business Email *</label>
                      <input required type="email" name="email" value={formData.email} onChange={handleChange} className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all text-gray-900 dark:text-white" placeholder="contact@business.com" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Primary Phone *</label>
                      <input required name="phone" value={formData.phone} onChange={handleChange} className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all text-gray-900 dark:text-white" placeholder="+91 98765 43210" />
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea name="description" value={formData.description} onChange={handleChange} rows={3} className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all text-gray-900 dark:text-white" placeholder="What makes your business special?"></textarea>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <textarea required name="address" value={formData.address} onChange={handleChange} rows={3} className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all text-gray-900 dark:text-white" placeholder="Building, Street, Landmark"></textarea>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">City *</label>
                      <input required name="city" value={formData.city} onChange={handleChange} className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all text-gray-900 dark:text-white" placeholder="Mumbai" />
                    </div>
                    <div>
                      <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">State *</label>
                      <input required name="state" value={formData.state} onChange={handleChange} className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all text-gray-900 dark:text-white" placeholder="Maharashtra" />
                    </div>
                  </div>
                  <div>
            ...
            {currentStep === 3 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-6">Details & Parking Configuration</h3>
                        ...
                        <div className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-2">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-gray-900 dark:text-white"
                            />
                          </div>
                          <div className="flex items-end pb-3">
                            <label className="flex items-center gap-2 cursor-pointer">
                              ...
                              />
                              <span className="text-sm font-bold text-gray-700 dark:text-gray-300">Valet Parking Available</span>
                            </label>
                          </div>
                        </div>
                      )}
            ...
            {currentStep === 4 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-6">Upload Media</h3>
                <p className="text-gray-500 dark:text-gray-400 mb-6">Upload photos of your storefront, menu, products, or interior to attract more customers.</p>
                ...
                <div className="border-2 border-dashed border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-[#1a1a1a] rounded-2xl p-10 flex flex-col items-center justify-center text-center">
                  ...
                  <label
                    htmlFor="imageUpload"
                    className="bg-gray-900 dark:bg-yellow-400 hover:bg-black dark:hover:bg-yellow-500 text-white dark:text-black px-6 py-3 rounded-xl font-bold cursor-pointer transition-colors shadow-md disabled:opacity-50"
                  >
            ...
            <div className="mt-12 pt-6 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold transition-colors ${currentStep === 1 ? "opacity-0 cursor-default" : "text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700"}`}
              >
              ...
              {currentStep < 4 ? (
                <button
                  onClick={handleNext}
                  disabled={loading}
                  className="flex items-center gap-2 px-8 py-3 rounded-xl font-bold text-black bg-yellow-400 hover:bg-yellow-500 shadow-lg shadow-yellow-400/30 transition-all"
                >
