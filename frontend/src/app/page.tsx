  ...
  return (
    <div className="bg-gray-50 md:bg-white min-h-screen text-gray-900 font-sans">
      ...
      <div className="md:hidden fixed bottom-24 right-4 z-40 flex items-center justify-end">
        <a href="/business/register" className="bg-yellow-400 hover:bg-yellow-500 text-yellow-900 rounded-full flex items-center justify-center p-4 shadow-lg shadow-yellow-400/40 border border-yellow-300 transition-transform active:scale-95 group relative">
