import { IOtpRepository } from '../../modules/auth/domain/repositories/otp.repository.interface';
import { Otp } from '../../modules/auth/domain/entities/otp.entity';
import { OtpModel, IOtpDocument } from '../database/models/misc.model';

// ─── Mongoose OTP Repository ───────────────────────────────────────────────────
